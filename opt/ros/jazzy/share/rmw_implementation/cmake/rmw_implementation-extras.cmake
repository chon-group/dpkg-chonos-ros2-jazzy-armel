...
if(OFF)
  message(STATUS "Using RMW implementation 'rmw_cyclonedds_cpp'")
  if(NOT requested_rmw_implementation STREQUAL "rmw_cyclonedds_cpp")
    message(FATAL_ERROR
      ...
      "only with support for 'rmw_cyclonedds_cpp'.")
  endif()
  ...
  if(DEFINED rmw_cyclonedds_cpp_TARGETS)
    ...
    target_link_libraries(rmw_implementation::rmw_implementation INTERFACE
      ${rmw_cyclonedds_cpp_TARGETS})
  elseif(TARGET rmw_cyclonedds_cpp::rmw_cyclonedds_cpp)
    ...
    target_compile_definitions(rmw_implementation::rmw_implementation INTERFACE
      ${rmw_cyclonedds_cpp_DEFINITIONS})
    target_include_directories(rmw_implementation::rmw_implementation INTERFACE
      ${rmw_cyclonedds_cpp_INCLUDE_DIRS})
    target_link_libraries(rmw_implementation::rmw_implementation INTERFACE
      ${rmw_cyclonedds_cpp_LIBRARIES})
  endif()
